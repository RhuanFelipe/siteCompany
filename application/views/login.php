				...
				<div class="row">
					<div class="col-lg-offset-3 col-lg-6 col-lg-offset-3 text-center">
						<div class="section-title">
							...
							<form class="login_form" id="login_form" method="POST" action="<?php base_url();?>restrict/ajax_login">
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<div class="input-group">
												...
												<input type="text" name="username" id="username" placeholder="Úsuario" class="form-control">
											</div>
										</div>
									</div>
								</div>
